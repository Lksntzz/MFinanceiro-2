    ...
    try {
      ...
      setError(
        refreshError?.message ||
          'Não foi possível carregar suas contas financeiras.',
      );
    } finally {
      setLoading(false);
    }
        ...
        <div className="space-y-4 animate-fade-in">
          <div>
            ...
            <p className="text-sm text-white/40">
              Cadastre somente lugares que representam saldo real: conta
              corrente, poupança ou dinheiro em espécie. Cartões e investimentos
              têm áreas próprias.
            </p>
          </div>
          ...
          {loading ? (
            <div className="mf-loading">Carregando contas...</div>
          ) : (
            <div className="grid gap-4 xl:grid-cols-[minmax(0,1.2fr)_minmax(320px,.8fr)]">
              <section className="glass-card mf-tool-surface space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-bold">Suas contas</h3>
                    <p className="text-[10px] text-white/40">
                      O saldo total do MF é a soma das contas ativas.
                    </p>
                  </div>
                </div>
                  ...
                  >
                    <div className="min-w-0">
                      ...
                      <div className="mt-1 text-[10px] text-white/40">
                        ...
                        {account.transaction_count} lançamento(s)
                      </div>
                    </div>
                ...
                <p className="text-[10px] text-white/35">
                  {activeAccounts.length} conta(s) ativa(s). Evite cadastrar
                  cartão de crédito ou ativo de investimento como conta para não
                  duplicar patrimônio.
                </p>
              </section>
              ...
              >
                <div>
                  <h3 className="text-sm font-bold">Adicionar conta</h3>
                  <p className="mt-1 text-[10px] text-white/40">
                    Use o saldo real no momento do cadastro.
                  </p>
                </div>

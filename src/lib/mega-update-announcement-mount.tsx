...
const WEB_UPDATE = {
  id: '2026-08-10-security-stability-hardening',
  title: 'Segurança e estabilidade reforçadas',
  dateLabel: '10 de agosto de 2026',
  summary: 'O MF Financeiro recebeu melhorias de segurança, estabilidade e organização para tornar a experiência web mais confiável e previsível no dia a dia.',
  highlights: [
    'A proteção da conta e das operações administrativas foi reforçada para reduzir riscos em ações sensíveis.',
    'A estrutura interna foi simplificada para deixar telas e recursos mais estáveis e evitar comportamentos duplicados.',
    'Falhas operacionais agora têm tratamento mais seguro, ajudando a preservar seus dados e acelerar correções.',
  ],
} as const;

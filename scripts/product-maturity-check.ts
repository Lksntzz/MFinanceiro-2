...
expectContains('src/lib/mega-update-announcement-mount.tsx', ['LATEST_WEB_UPDATE', 'releaseReadKey']);
...
expectNotContains('supabase/migrations/20260810144500_user_activity_history.sql', [
...
expectContains('src/product-maturity-additions.css', ['mf-onboarding-checklist', 'mf-automation-disclosure']);

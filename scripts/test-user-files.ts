...
async function main() {
  const pdfPath =
    'C:\\Users\\Lukas\\Downloads\\MFinanceiro_Portfolio_1776904377757.pdf';
  const xlsxPath =
    'C:\\Users\\Lukas\\Downloads\\MFinanceiro_Relatorio_Transacoes_1776901366858.xlsx';
  ...
  const pdfFile = new File(
    [pdfBuf],
    'MFinanceiro_Portfolio_1776904377757.pdf',
    {
  ...
  const xlsxFile = new File(
    [xlsxBuf],
    'MFinanceiro_Relatorio_Transacoes_1776901366858.xlsx',
    {
